...
$lang['bbCodeTitleURL'] = 'Lisää URL: [url]http://example.org[/url] tai [url=http://example.org]teksti[/url]';
$lang['bbCodeTitleImg'] = 'Insert image: [img]http://example.org/image.jpg[/img]';
$lang['bbCodeTitleColor'] = 'Fontin väri: [color=red]teksti[/color]';
$lang['help'] = 'Ohje';
...
$lang['helpItemDescPrivateMessage'] = 'Yksityinen viesti:';
...
$lang['helpItemDescAction'] = 'Kuvaile toimintaa:';
$lang['helpItemCodeAction'] = '/action Teksti';
$lang['helpItemDescDescribe'] = 'Kuvaile toimintaa yksityisessä viestissä:';
$lang['helpItemCodeDescribe'] = '/describe Käyttäjätunnus Teksti';
$lang['helpItemDescIgnore'] = 'Kiellä tai hyväksy viestejä käyttäjältä:';
...
$lang['helpItemDescWhereis'] = 'Näytä käyttäjän kanava:';
...
$lang['helpItemDescNick'] = 'Vaihda käyttäjänimeä:';
...
$lang['settingsHyperLinks'] = 'Hyperlinkit päälle:';
$lang['settingsLineBreaks'] = 'Rivinvaihdot päälle:';
$lang['settingsEmoticons'] = 'Hymiöt päälle:';
$lang['settingsAutoFocus'] = 'Automaattisesti fokusoi tekstinsyöttökenttä:';
$lang['settingsMaxMessages'] = 'Suurin määrä viestejä listassa:';
$lang['settingsWordWrap'] = 'Pitkien sanojen rivinvaihto päälle:';
$lang['settingsMaxWordLength'] = 'Sanan maksimipituus ennen kuin riviä vaihdetaan:';
...
$lang['settingsBlinkIntervalNumber'] = 'Vilkutus intervalleja:';
...
$lang['errorBanned'] = 'Tämä IP on potkittu';
