...
* @file				dl_admin_permissions.php 4 2009/06/25 OXPUS
...
$view_perm			= request_var('view_perm', false);

if ($view_perm && isset($s_presel_cats[0]))
{
	$cat_id = $s_presel_cats[0];
...
$template->assign_vars(array(
	'L_DL_PERMISSIONS'	=> $user->lang['DL_ACP_PERMISSIONS'],
	'L_SELECT_CAT'		=> $user->lang['DL_SELECT_CAT'],
	'L_SELECT_CATS'		=> $user->lang['DL_SELECT_CATS'],
	'L_SELECT_GROUP'	=> $user->lang['DL_SELECT_GROUP'],
	'L_SELECT_GROUPS'	=> $user->lang['DL_SELECT_GROUPS'],
	'L_AUTH_VIEW'		=> $user->lang['DL_AUTH_VIEW'],
	'L_AUTH_DL'			=> $user->lang['DL_AUTH_DL'],
	'L_AUTH_UP'			=> $user->lang['DL_AUTH_UP'],
	'L_AUTH_MOD'		=> $user->lang['DL_AUTH_MOD'],
	'L_AUTH_CREAD'		=> $user->lang['DL_AUTH_CREAD'],
	'L_AUTH_CPOST'		=> $user->lang['DL_AUTH_CPOST'],
	'L_SET'				=> $user->lang['DL_SET'],
	'L_VIEW_PERM'		=> $user->lang['DL_VIEW_PERM'],
	'L_ALL'				=> $user->lang['DL_ALL'],
