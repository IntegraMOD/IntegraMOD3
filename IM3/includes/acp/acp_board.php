			...
			case 'post':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'legend3'				=> 'SOCIAL_BOOKMARKS',
						'allow_dig'				=> array('lang' => 'ALLOW_DIG',				'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_del'				=> array('lang' => 'ALLOW_DEL',				'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_slashdot'		=> array('lang' => 'ALLOW_SLASHDOT',		'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_rds'				=> array('lang' => 'ALLOW_RDS',				'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_spurl'			=> array('lang' => 'ALLOW_SPURL',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_linkagogo'		=> array('lang' => 'ALLOW_LINKAGOGO',		'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_reddit'			=> array('lang' => 'ALLOW_REDDIT',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_tech'			=> array('lang' => 'ALLOW_TECH',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_google'			=> array('lang' => 'ALLOW_GOOGLE',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_prop'			=> array('lang' => 'ALLOW_PROP',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_netv'			=> array('lang' => 'ALLOW_NETV',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
						'allow_stumble'			=> array('lang' => 'ALLOW_STUMBLE',			'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
