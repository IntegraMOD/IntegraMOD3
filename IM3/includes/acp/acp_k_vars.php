...
*/
		...
		$template->assign_vars(array(
			...
			'S_SHOW_BLOCKS_ON_KB_L'					=> ($k_config['show_lb_ipsmuy'][7]) ? true : false,
			'S_SHOW_BLOCKS_ON_KB_R'					=> ($k_config['show_rb_ipsmuy'][7]) ? true : false,
			'S_SHOW_BLOCKS_ON_DLM_L'				=> ($k_config['show_lb_ipsmuy'][8]) ? true : false,
			'S_SHOW_BLOCKS_ON_DLM_R'				=> ($k_config['show_rb_ipsmuy'][8]) ? true : false,
		...
		switch ($mode)
		{
			case 'save':
			{
				...
				$k_config['show_lb_ipsmuy'][1]			= request_var('show_blocks_on_index_l', '');
				$k_config['show_rb_ipsmuy'][1]			= request_var('show_blocks_on_index_r', '');
				$k_config['show_lb_ipsmuy'][2]			= request_var('show_blocks_on_portal_l', '');
				$k_config['show_rb_ipsmuy'][2]			= request_var('show_blocks_on_portal_r', '');
				$k_config['show_lb_ipsmuy'][3]			= request_var('show_blocks_on_search_l', '');
				$k_config['show_rb_ipsmuy'][3]			= request_var('show_blocks_on_search_r', '');
				$k_config['show_lb_ipsmuy'][4]			= request_var('show_blocks_on_mcp_l', '');
				$k_config['show_rb_ipsmuy'][4]			= request_var('show_blocks_on_mcp_r', '');
				$k_config['show_lb_ipsmuy'][5]			= request_var('show_blocks_on_ucp_l', '');
				$k_config['show_rb_ipsmuy'][5]			= request_var('show_blocks_on_ucp_r', '');
				$k_config['show_lb_ipsmuy'][6]			= request_var('show_blocks_on_members_l', '');
				$k_config['show_rb_ipsmuy'][6]			= request_var('show_blocks_on_members_r', '');
				$k_config['show_lb_ipsmuy'][7]			= request_var('show_blocks_on_kb_l', '');
				$k_config['show_rb_ipsmuy'][7]			= request_var('show_blocks_on_kb_r', '');
				$k_config['show_lb_ipsmuy'][8]			= request_var('show_blocks_on_download_l', '');
				$k_config['show_rb_ipsmuy'][8]			= request_var('show_blocks_on_download_r', '');
