...
*
* @package acp
* @version $Id: acp_shoutbox.php 253 2008-02-16 13:50:55Z paul $
		    ...
		    case 'settings':
				...
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'as_on_index'      		=> array('lang' => 'AS_SHOW_ON_INDEX',      'validate' => 'bool',   'type' => 'radio:yes_no', 'explain' => true),
						'as_override_user' 		=> array('lang' => 'AS_OVERRIDE_USER',      'validate' => 'bool',   'type' => 'radio:yes_no', 'explain' => true),
					)
				);
			break;
