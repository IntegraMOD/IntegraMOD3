...
#';
		...
		$this->imageset_keys = array(
			...
			'buttons'	=> array(
				'icon_back_top', 'icon_contact_aim', 'icon_contact_email', 'icon_contact_icq', 'icon_contact_jabber', 'icon_contact_msnm', 'icon_contact_pm', 'icon_contact_yahoo', 'icon_contact_www', 'icon_post_delete', 'icon_post_edit', 'icon_post_info', 'icon_post_quote', 'icon_post_report', 'icon_user_online', 'icon_user_offline', 'icon_user_profile', 'icon_user_search', 'icon_user_warn', 'button_pm_forward', 'button_pm_new', 'button_pm_reply', 'button_topic_locked', 'button_topic_new', 'button_topic_reply', 'button_topic_qreply', 'button_topic_qreply_no', 'dig', 'del', 'slashdot', 'rds', 'spurl', 'linkagogo', 'reddit', 'tech', 'google', 'prop', 'netv', 'stumble', 'button_upload_image',
			),
			'icons'		=> array(
				'icon_post_target', 'icon_post_target_unread', 'icon_topic_attach', 'icon_topic_latest', 'icon_topic_newest', 'icon_topic_reported', 'icon_topic_unapproved', 'icon_friend', 'icon_foe', 'icon_ajax_checking', 'icon_ajax_true', 'icon_ajax_false', 'icon_ajax_password_strength_1', 'icon_ajax_password_strength_2', 'icon_ajax_password_strength_3', 'icon_ajax_password_strength_4',
			),
			'forums'	=> array(
