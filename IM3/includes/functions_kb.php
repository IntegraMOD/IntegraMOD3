...
* @version $Id: functions_kb.php, v 0.2.12 2009/06/06 20:21:36 tas2580 Exp $
...
{
	global $auth, $cache, $phpbb_root_path, $db, $phpEx, $user, $config, $kb_config;
...
function delete_article($id)
{
	...
	if ($auth->acl_get('m_del_kb') || ($auth->acl_get('u_del_kb') && $row['user_id'] == $user->data['user_id']))
	{
		if (confirm_box(true))
		{
			$sql = 'SELECT *
