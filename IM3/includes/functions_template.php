	...
	function _tpl_load_file($handle, $store_in_db = false)
	{
		...
		if(STARGATE)
		{
			if (!file_exists($this->template->files[$handle]))
			{
				...
				{
					$alt_filenpath = $php_root_path . 'styles/portal_common/template/blocks/' . $missing_filename;
				}
				else
				{
					$alt_filenpath = $php_root_path . 'styles/portal_common/template/' . $missing_filename;
				}
