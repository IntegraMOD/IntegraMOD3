		...
		switch ($mode)
		{
			case 'reg_details':
				...
				$data = array(
					...
					'user_country_flag'	=> request_var('user_country_flag', $user->data['user_country_flag'], true),
				);
			...
			case 'profile_info':
				...
				$data = array(
					...
					'user_country_flag'	=> utf8_normalize_nfc(request_var('user_country_flag', $user->data['user_country_flag'], true)),
				);
				...
				if ($submit)
				{
					$validate_array = array(
						...
						'user_country_flag'	=> array('string', true, 5,6),
					);
