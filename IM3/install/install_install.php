	...
	function main($mode, $sub)
	{
		...
		switch ($sub)
		{
			...
			case 'final':
				...
				set_config('imod3_version', '3.0.7b');
...
*/
		...
		$directories = array('cache/', 'files/', 'store/', 'dl_mod/downloads/', 'dl_mod/thumbs/', 'gallery/images/cache/', 'gallery/images/import/', 'gallery/images/medium/', 'gallery/images/upload/', 'knowledge/images/');
