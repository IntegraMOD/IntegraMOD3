...
* @version $Id: kb_categorie.php, v 0.2.12 2009/06/06 20:21:36 tas2580 Exp $
...
$template->assign_vars(array(
	'PAGINATION'		=> generate_pagination('kb_categorie.php?id=' . $cat_id, $total_articles, $config['topics_per_page'], $start),
