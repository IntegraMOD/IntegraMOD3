...
$lang = array_merge($lang, array(
    ...
    $lang = array_merge($lang, array(
        'acl_u_view_event'    => array('lang' => 'Kann Termine sehen', 'cat' => 'calendar'),
        'acl_u_new_event'     => array('lang' => 'Kann neue Termine erstellen', 'cat' => 'calendar'),
        'acl_u_edit_event'    => array('lang' => 'Kann eigene Termine ändern', 'cat' => 'calendar'),
        'acl_u_delete_event'  => array('lang' => 'Kann eigene Termine löschen', 'cat' => 'calendar'),
       
        'acl_f_view_event'    => array('lang' => 'Kann Termine sehen', 'cat' => 'calendar'),
        'acl_f_new_event'     => array('lang' => 'Kann neue Termine erstellen', 'cat' => 'calendar'),
        'acl_f_edit_event'    => array('lang' => 'Kann eigene Termine ändern', 'cat' => 'calendar'),
        'acl_f_delete_event'  => array('lang' => 'Kann eigene Termine löschen', 'cat' => 'calendar'),

        'acl_m_edit_event'    => array('lang' => 'Kann Termine anderer Benutzer ändern', 'cat' => 'calendar'),
        'acl_m_delete_event'  => array('lang' => 'Kann Termine anderer Benutzer löschen', 'cat' => 'calendar'),
       
        'acl_a_calendar_manage'=> array('lang' => 'Kann Kalender verwalten', 'cat' => 'calendar'),
        'acl_a_edit_event'    => array('lang' => 'Kann Termine anderer Benutzer ändern', 'cat' => 'calendar'),
        'acl_a_delete_event'  => array('lang' => 'Kann Termine anderer Benutzer löschen', 'cat' => 'calendar'),

       'acl_a_publish_rss'   => array('lang' => 'Kann Kalender-RSS-Feeds veröffentlichen', 'cat' => 'calendar'),
    ));
    //---END CALENDAR MOD---
