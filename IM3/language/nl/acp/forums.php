...
$lang = array_merge($lang, array(
	'AUTO_PRUNE_DAYS'					=> 'Bericht leeftijd bij automatisch opruimen',
	...
	'CONTINUE'						=> 'Continue',
	'COPY_PERMISSIONS'					=> 'Kopieer rechten van',
	...
	'COPY_PERMISSIONS_ADD_EXPLAIN'		=> 'Eens gecre&euml;erd heeft het forum dezelfde rechten als die je geselecteerd hebt. Als er geen forum geselecteerd is, wordt het nieuwe forum niet zichtbaar totdat de rechten ingesteld zijn.',
	'COPY_PERMISSIONS_EDIT_EXPLAIN'		=> 'Als je kopieerrechten geselecteerd hebt, krijgt het forum dezelfde rechten als de geselecteerde. Dit overschrijft alle hiervoor geselecteerde rechten. Als je geen forum geselecteerd hebt worden de huidige rechten bewaard.',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'In phpBB3 zijn er geen categorie&euml;n, alles is forumgebaseerd. Elk forum kan een oneindige aantal subforums bevatten en je kan aangeven waar wel in gepost mag worden en waar niet (het werkt hetzelfde als een oude categorie). Hier kun je toevoegen, bewerken, verwijderen, sluiten en heropenen van individuele forums en toegevoegde instellingen instellen. Als je berichten en onderwerpen niet meer synchroon zijn, kan je het forum terug hersynchroniseren. <strong>Je moet rechten gekopieerd of ingesteld hebben om nieuw aangemaakte forums te kunnen zien.</strong>',
	...
	'FORUM_EDIT_EXPLAIN'				=> 'Met het formulier hieronder kan je het forum instellen. Wees je ervan bewust dat moderatie en berichtenaantallen ingesteld worden via de forumrechten voor iedere gebruiker en gebruikersgroep.',
	...
	'NO_PERMISSIONS'					=> 'Kopieer de rechten niet',
	'NO_PERMISSION_FORUM_ADD'			=> 'Je hebt niet de juiste rechten om forums toe te voegen.',
	'NO_PERMISSION_FORUM_DELETE'		=> 'Je hebt niet de juiste rechten om forums te verwijderen.',
	...
	'REDIRECT_ACL'						=> 'Je kunt nu de %srechten instellen%s voor dit forum.',
