...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> 'Vanuit dit paneel kun je al jouw gebruikersgroepen beheren en je bestaande groepen verwijderen en wijzigen. Verder kun je groepsleiders kiezen, switchen tussen statussen open/verborgen/gesloten voor een groep en de groepsbeschrijving aanpassen.',
	'ADD_USERS'						=> 'Voeg gebruikers toe',
	'ADD_USERS_EXPLAIN'				=> 'Hier kun je nieuwe gebruikers aan de groep toevoegen. Je kunt ook kiezen of dit de standaard groep moet worden voor de geselecteerde gebruiker(s). Bovendien kun je hen groepsleider maken. Zet elke gebruikersnaam op een aparte lijn.',

	'COPY_PERMISSIONS'				=> 'Kopieer rechten van',
	'COPY_PERMISSIONS_EXPLAIN'		=> 'Eenmaal aangemaakt, zal de groep de rechten van de geselecteerde groep(en) krijgen.',
	...
	'GROUP_FOUNDER_MANAGE_EXPLAIN'	=> 'Beperk het beheer voor deze groep van beheerders. Gebruikers met groepsrechten zullen deze groep en zijn leden nog steeds kunnen zien.',
	...
	'GROUP_LIST_EXPLAIN'			=> 'Dit is een complete lijst of leden die een lidmaatschap tot deze groep hebben. Je kunt leden verwijderen (behalve in zekere speciale groepen) of nieuwe leden toevoegen.',
	...
	'GROUP_UPDATED'					=> 'Groeps instellingen succesvol bijgewerkt.',
	...
	'NO_PERMISSIONS'			=> 'Rechten niet kopi&euml;ren',
	...
	'SPECIAL_GROUPS_EXPLAIN'	=> 'Voorgedefinieerde groepen zijn speciale groepen. Ze kunnen niet verwijderd of rechtstreeks gewijzigd worden, maar je kunt nog wel gebruikers toevoegen en basis instellingen wijzigen.',
