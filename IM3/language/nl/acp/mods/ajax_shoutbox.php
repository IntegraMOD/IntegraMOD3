...
$lang = array_merge($lang, array(
	...
	'AS_SHOW_ON_INDEX'			=> 'Show on Index',
	'AS_SHOW_ON_INDEX_EXPLAIN'	=> 'Optionally enable or disable the shoutbox on the index page.',
	'AS_OVERRIDE_USER'			=> 'Override user index option',
	'AS_OVERRIDE_USER_EXPLAIN'	=> 'Users may decide if they want to see the shoutbox on the index page via an option in the UCP. This option overrides the user\'s preference',
));
?>