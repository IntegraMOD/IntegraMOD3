...
$lang = array_merge($lang, array(
	...
	'BOOL_TYPE_EXPLAIN'				=> 'Definieer het type: checkbox of radio buttons. Een checkbox zal enkel worden weergegeven als het is aangegeven voor een gebruiker. In dat geval zal de tweede taaloptie gebruikt worden. Radio buttons weergave wordt enkel bepaald door de waarde.',
	...
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> 'De profielvelden zullen worden getoond op alle plaatsen aangegeven in de serverprestatie instellingen. Indien je voor &quot;nee&quot; koos, zal het veld van onderwerppagina\'s, profielen en de ledenlijst niet worden getoond.',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Alleen administrators en moderators kunnen dit veld zien en invullen. Als voor deze keuze wordt gekozen, zal het profielveld alleen worden weergegeven in gebruikersprofielen.',
	...
	'STEP_1_EXPLAIN_CREATE'			=> 'Je kunt hier de eerste basisparameters invullen van je nieuw profielveld. Deze info is nodig in de tweede stap, waar je overige opties kan instellen.',
	'STEP_1_EXPLAIN_EDIT'			=> 'Hier kun je de basisparameters van je profielveld wijzigen. De relevante opties worden in de tweede stap herberekend.',
	'STEP_1_TITLE_CREATE'			=> 'Voeg profielveld toe',
	'STEP_1_TITLE_EDIT'				=> 'Wijzig profielveld',
	'STEP_2_EXPLAIN_CREATE'			=> 'Hier kun je standaardinstellingen, die je wil wijzigen, opgeven.',
	'STEP_2_EXPLAIN_EDIT'			=> 'Hier kun je enkele standaardinstellingen wijzigen.<br /><strong>Veranderingen aan profielvelden zullen geen effect hebben op bestaande profielvelden ingevuld door jouw gebruikers</strong>',
