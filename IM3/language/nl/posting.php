...
$lang = array_merge($lang, array(
	...
	'CANNOT_DELETE_REPLIED'		=> 'Sorry, maar je kun alleen berichten verwijderen waarop nog niet gereageerd is.',
	'CANNOT_EDIT_POST_LOCKED'	=> 'Dit bericht is gesloten. Je kunt dit bericht niet langer bewerken.',
	'CANNOT_EDIT_TIME'			=> 'Je kunt dat bericht niet meer bewerken of verwijderen.',
	'CANNOT_POST_ANNOUNCE'		=> 'Sorry, maar je kunt geen mededelingen plaatsen.',
	'CANNOT_POST_STICKY'		=> 'Sorry, maar je kunt geen belangrijke onderwerpen plaatsen.',
	...
	'DELETE_OWN_POSTS'			=> 'Sorry, maar je kunt alleen je eigen berichten verwijderen.',
	...
	'DRAFT_LOADED'				=> 'Het concept werd in het tekstveld geladen, je kunt het bericht nu be&euml;indigen en plaatsen.<br />Je concept wordt, na het plaatsen van het bericht, verwijderd.',
	'DRAFT_LOADED_PM'			=> 'Het concept werd in het tekstveld geladen, je kunt het priv&eacute; bericht nu be&euml;indigen en plaatsen.<br />Je concept wordt, na het plaatsen van het priv&eacute; bericht, verwijderd.',
	...
	'EMPTY_REMOTE_DATA'			=> 'Het bestand kan niet ge&uuml;pload worden, probeer het nog eens handmatig te uploaden.',
	...
	'IMAGES_ARE_OFF'			=> '[img] is <em>UIT</em>',
	'IMAGES_ARE_ON'				=> '[img] is <em>AAN</em>',
	'INVALID_FILENAME'			=> '%s is een ongeldige bestandsnaam.',

	'LOAD'						=> 'Laden',
	'LOAD_DRAFT'				=> 'Concept laden',
	'LOAD_DRAFT_EXPLAIN'		=> 'Hier is het mogelijk om een concept te selecteren waarmee je verder gaat met schrijven. Je huidige bericht wordt geannuleerd, alle huidige berichtinhoud wordt verwijderd. Tonen, bewerken en verwijderen van concepten kun in je gebruikers controlepaneel.',
	...
	'NO_DELETE_POLL_OPTIONS'	=> 'Je kunt de poll opties, waar al op gestemd is, niet verwijderen.',
	...
	'POLL_TITLE_COMP_TOO_LONG'	=> 'De uiteindelijke lengte van je poll titel is te groot, kijk of je geen smilies en BBCodes kunt verwijderen.',
	...
	'TOO_MANY_ATTACHMENTS'		=> 'Je kunt niet nog een bijlage toevoegen, %d is het maximum.',
	...
	'TOO_MANY_USER_OPTIONS'		=> 'Je kunt niet meer keuzes per gebruiker toestaan dan het aanwezige aantal poll opties.',
	'TOPIC_BUMPED'				=> 'Onderwerp is succesvol gebumpt.',

	'UNAUTHORISED_BBCODE'		=> 'Je kunt geen gebruik maken van de volgende BBCodes: %s.',
	'UNGLOBALISE_EXPLAIN'		=> 'Om over te schakelen van algemene mededeling naar normaal onderwerp, zul je een forum voor dit bericht moeten kiezen.',
	'UPDATE_COMMENT'			=> 'Werk commentaar bij',
	'URL_INVALID'				=> 'De opgegeven url is ongeldig.',
	'URL_NOT_FOUND'				=> 'Het bestand dat je opgegeven hebt kan niet gevonden worden.',
	'URL_IS_OFF'				=> '[url] is <em>UIT</em>',
	'URL_IS_ON'					=> '[url] is <em>AAN</em>',
	...
	'USER_CANNOT_REPLY'			=> 'Je kunt niet antwoorden op berichten in dit forum.',
	'USER_CANNOT_FORUM_POST'	=> 'Je kunt niet deze berichtactie door zetten, omdat dit forumtype dit niet ondersteund.',

	'VIEW_MESSAGE'				=> '%sBekijk je geplaatste bericht%s',
	...
	'WRONG_SIZE'				=> 'De afbeelding moet op z\'n minst %1$d pixels breed, %2$d pixels hoog zijn en maximaal %3$d pixels breed en %4$d pixels hoog. De toegevoegde afbeelding is %5$d pixels breed en %6$d pixels hoog.',
));
