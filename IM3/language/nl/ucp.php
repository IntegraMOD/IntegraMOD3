...
$lang = array_merge($lang, array(
	...
	<br />
	Je wachtwoord is versleuteld (en kan niet terug leesbaar gemaakt worden), waardoor het op een veilige manier opgeslagen is. Desondanks is het niet aan te raden dat je hetzelfde wachtwoord op een groot aantal websites gebruikt. Je wachtwoord is het middel waarmee je op je account op &quot;%1$s&quot; kunt inloggen; bewaar het dus veilig en link het op geen enkele manier aan &quot;%1$s&quot;, phpBB of aan een andere derde partij. Als je het wachtwoord van je account zou vergeten, kun je de &quot;wachtwoord vergeten&quot; optie gebruiken die de phpBB-software voorziet. Dit proces vereist dat je je gebruikersnaam en e-mailadres opgeeft, waarna de phpBB-software een nieuw wachtwoord zal genereren om opnieuw in te loggen.<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'BOARD_DST'						=> 'Zomertijd/zomeruur /<abbr title="Daylight Saving Time">DST</abbr> is aktief',
	...
	'CONFIRM_EXPLAIN'				=> 'Om automatische registraties tegen te gaan vereist de beheerder dat je een bevestigingscode intypt. De code wordt hieronder in een afbeelding weergegeven. Als je visuele problemen hebt, of om een andere reden de code niet kunt lezen en/of zien, contacteer dan de %sbeheerder%s.',
	'VC_REFRESH'					=> 'Ververs confirmatie code',
	'VC_REFRESH_EXPLAIN'			=> 'Als u de code niet kunt lezen, kunt u door op de knop te klikken, een nieuwe aanvragen.',
	...
	'EDIT_DRAFT_EXPLAIN'			=> 'Hier kun je jouw concept bewerken. Concepten bevatten geen bijlagen of poll informatie.',
	...
	'FOES_EXPLAIN'					=> 'Vijanden zijn gebruikers die je standaard negeert. Berichten van die gebruikers worden niet volledig worden getoond, ook worden priv&eacute; berichten van de gebruiker niet verstuurd. Let op; het is niet mogelijk om moderators of beheerders te negeren.',
	...
	'FOLDER_NAME_EMPTY'				=> 'Je moet een naam opgeven voor deze map.',
	...
	'FORCE_PASSWORD_EXPLAIN'		=> 'Voordat je verder kunt gaan op het forum, moet je jouw wachtwoord wijzigen',
	...
	'GLOBAL_ANNOUNCEMENT'			=> 'Algemene mededeling',
	...
	'HOLD_NEW_MESSAGES_SHORT'		=> 'Nieuwe berichten worden achtergehouden',	'GROUPS_EXPLAIN'		=> 'Gebruikersgroepen maken het werk van de beheerder een stuk gemakkelijker. Standaard word je in een groep geplaatst, dit is je standaardgroep. Deze groep bepaalt hoe je bij andere overkomt, bijvoorbeeld een kleur, avatar, rang, etc. Afhankelijk van de instellingen van de beheerder kun je al dan niet van groep veranderen. Je kunt ook aan groepen toegevoegd worden of jezelf eraan toevoegen. Sommige groepen geven je extra rechten, Daarmee kun je meer inhoud zien of bepaalde acties uitvoeren.',
	...
	'NOT_ADDED_FRIENDS_BOTS'		=> 'Je kunt bots niet aan je vrienden lijst toevoegen.',
	...
	'NOT_ADDED_FOES_BOTS'			=> 'Je kunt bots niet aan je vijanden lijst toevoegen.',
	'NOT_ADDED_FOES_FRIENDS'		=> 'Je kunt gebruikers uit je vriendenlijst niet aan je vijandenlijst toevoegen.',
	...
	'NO_AUTH_DELETE_MESSAGE'		=> 'Je beschikt niet over de juiste rechten om priv&eacute; berichten te verwijderen.',
	'NO_AUTH_EDIT_MESSAGE'			=> 'Je beschikt niet over de juiste rechten om priv&eacute; berichten te wijzigen.',
	'NO_AUTH_FORWARD_MESSAGE'		=> 'Je beschikt niet over de juiste rechten om priv&eacute; berichten door te sturen.',
	'NO_AUTH_GROUP_MESSAGE'			=> 'Je beschikt niet over de juiste rechten om priv&eacute; berichten naar groepen te sturen.',
	...
	'NO_AUTH_READ_MESSAGE'			=> 'Je beschikt niet over de juiste rechten om priv&eacute; berichten te lezen.',
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'Je kunt het bericht niet lezen omdat het door de auteur verwijderd is.',
	'NO_AUTH_SEND_MESSAGE'			=> 'Je beschikt niet over de juiste rechten om priv&eacute; berichten te versturen.',
	'NO_AUTH_SIGNATURE'				=> 'Je beschikt niet over de juiste rechten om een onderschrift in te stellen',

	'NO_BCC_RECIPIENT'				=> 'Geen',
	'NO_BOOKMARKS'					=> 'Je hebt geen bladwijzers',
	'NO_BOOKMARKS_SELECTED'			=> 'Je hebt geen bladwijzers geselecteerd',
	'NO_EDIT_READ_MESSAGE'			=> 'Het Priv&eacute; bericht kan niet worden gewijzigd omdat hij al is gelezen.',
	...
	'PERMISSIONS_RESTORED'			=> 'Rechten succesvol teruggezet.',
	'PERMISSIONS_TRANSFERRED'		=> 'Rechten succesvol overgezet naar <strong>%s</strong>, je bent nu in staat om te surfen op het forum met de rechten van deze gebruiker.<br />Vergeet niet dat de beheerders rechten niet zijn meegegeven. Je kunt op elk moment terug naar je eigen rechten.',
	...
	'SIGNATURE_EXPLAIN'					=> 'Een blok tekst dat je optioneel aan al je berichten kunt toevoegen. Er is een limiet van %d tekens.',
	...
	'UCP_PREFS_POST'					=> 'Wijzig bericht standaarden',
	...
	'UCP_PROFILE_REG_DETAILS'			=> 'Wijzig registratie details',
	...
	'VIEW_SHOUT_INDEX'			=> 'Display shoutbox on index page',
	'VIEW_CAL_INDEX'			=> 'Display mini calendar on index page',
	...
	'GROUPS_EXPLAIN'			=> 'Gebruikers groepen maken het Beheerders mogelijk om beter gebruikers te beheren. Standaard wordt je geplaatst in een specifieke groep, dat is je standaard groep. Deze groep bepaald hoe andere gebruikers je zien, bijvoorbeeld je gebruikersnaam kleur, avatar, rang, etc. Afhankelijk van of de beheerder het u toestaat, kunt u toestemming krijgen om uw standaardgroep te veranderen. U kunt ook worden geplaatst in, of toestemming krijgen lid te worden, van andere groepen. Sommige groepen kunnen u extra rechten geven om bepaalde inhoud te bekijken, of uw mogelijkheden op andere gebieden te verhogen.',
